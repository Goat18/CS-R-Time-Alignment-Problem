...
\author{
	...
	In \cite{CR22} we posed the general timed alignment problem, which formalised the notion of aligning timed traces to timed process models.  %Time Petri nets offer both a graphical means by which to represent concurrent systems, but their semantics also allow one to express complex time constraints. 
