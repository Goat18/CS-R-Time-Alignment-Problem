...
We have implemented the $d_N$ computation algorithm and the $d_N$ alignment algorithm for linear process models in python, available at https://github.com/NehaRino/TimedAlignments. Both algorithms have linear time complexity, and so, they have efficient running times, as evidenced by the table below : 
\begin{tabular}{|r| |r|}
	\hline
	Trace Length & Running Time (seconds) \\ 
	\hline
	10 & 2.4853510003595146e-05\\
	100 & 0.00023651171000892645\\
	1000 &0.0025955689300099036\\
	10000& 0.02811378448999676\\
	100000& 0.33130915412000833\\
