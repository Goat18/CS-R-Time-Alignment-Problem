...
Distances over timed words have been explored before, such as in \cite{AsarinBD18} and \cite{CIM14}, both of which have in common the notion of capturing the maximal difference between the timestamps attached to the same action label. 
...
\todo[inline]{Thomas: Neha, could you insert the configuration on which you ran the experiments, (Processor, frequency, RAM)?}
		...
		In \cite{AsarinBD18}, the distance function finds the maximal timing deviation between any two events that correspond to the same action, and is closely related to the Hausdorff distance between point-sets. 
