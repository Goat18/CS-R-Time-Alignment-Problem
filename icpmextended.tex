    ...
    \begin{example}\label{Branchingcp}
        ...
        \adjustbox{scale = 0.8}{
            \begin{tikzcd}
                ...
                &\bigcirc& {\fbox{ct}} & \bigcirc & {\fbox{dec}} & \bigcirc
...
Note that for extended free choice time petri nets, in order to check for the validity of a timing function, checking all of $C_e$ as before is no longer necessary. 
	...
	\end{proof}
		...
		The latter two allow for differences in the number and placement of actions in the word, while the first work pointedly does not. 
