...
Since both chronology and co-operation both improve cost when computing $d_{\alpha}$, whenever the cost of the stamp move is at least twice as much as the cost of the delay move, any sequence of $\alpha$ weighted mixed moves can be converted to one with lesser or equal cost. 
