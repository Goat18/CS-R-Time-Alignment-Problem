...
%	\subsection{Conformance Checking and Alignments} 
	...
	In Arya Adriansyah's seminal thesis \cite{Adriansyah2014AligningOA}, we obtain the notion of an alignment, or, the minimal series of corrections needed to transform an observed event trace into the execution of the process model.  
